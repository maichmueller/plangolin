...
from plangolin.encoding.base_encoder import EncoderFactory
from plangolin.logging_setup import get_logger
from plangolin.models import *  # noqa: F401
from plangolin.rl.data import *  # noqa: F401
...
class ThundeRLCLI(LightningCLI):
    ...
    def before_fit(self):
        if self.trainer.logger is not None:
            ...
            if wandb_extra.log_code:  # save everything inside src/plangolin
