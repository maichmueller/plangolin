...
from plangolin.algorithms import PolicyEvaluationMP
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for idx, env in tqdm(
            enumerate(envs),
            total=len(envs),
            desc="Building state space graphs for validation problems",
        ):
            ...
            self.message_passing[idx] = PolicyEvaluationMP(
